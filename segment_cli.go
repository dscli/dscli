...
var segmentPreviewCmd = &cobra.Command{
...
// segmentTestCmd 测试模板
var segmentTestCmd = &cobra.Command{
	Use:   "test",
	Short: "测试模板语法",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx := context.Background()
...
var segmentExamplesCmd = &cobra.Command{
	Use:   "examples",
	Short: "查看段落示例",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Println("可用段落示例:")
...
func init() {
	...
	segmentCmd.AddCommand(segmentCreateCmd)
	segmentCmd.AddCommand(segmentPreviewCmd)
	segmentCmd.AddCommand(segmentTestCmd)
	segmentCmd.AddCommand(segmentExamplesCmd)
