...
var (
	...
	CurrentModelID   = ContextKeyType("CurrentModelID")
	CurrentModelName = ContextKeyType("CurrentModelName")
	CurrentDomainID  = ContextKeyType("CurrentDomainID")
	CurrentSessionID = ContextKeyType("CurrentSessionID")
